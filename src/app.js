...
var app = angular.module(moduleName, ['ui.router', 'satellizer', 'btford.socket-io', angularBootstrapNpm, chatAppSocket, services, ChatCtrl, AuthCtrl, ImgPopupCtrl, 'ngImgCrop']);
